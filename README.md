  ...
  return (
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        <nav>
          <ul>
            ...
            <li><Link href="/learn"><a>Learn</a></Link></li>
            <li><Link href="/templates"><a>Templates</a></Link></li>
            <li><Link href="/deploy"><a>Deploy</a></Link></li>
          </ul>
        </nav>
      </header>
      ...
      <footer className={styles.footer}>
        <a
          href="https://vercel.com?utm_medium=default-template&filter=next.js&utm_source=create-next-app&utm_campaign=create-next-app-readme"
          target="_blank"
